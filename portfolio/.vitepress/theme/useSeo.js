...
export function useSeo() {
  ...
  function updateMetaTags() {
    ...
    updateOrCreateMeta('property', 'og:url', `${siteConfig.url}${currentPath === '/' ? '' : currentPath}`)
    ...
    if (currentPath === '/publications') {
      ...
      updateOrCreateMeta('name', 'citation_author_email', config.academicSEO.googleScholar.authorEmail)
      updateOrCreateMeta('name', 'citation_author_institution', config.academicSEO.googleScholar.institution)
    }
  }
