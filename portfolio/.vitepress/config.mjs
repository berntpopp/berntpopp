...
const defaultConfig = {
  site: {
    title: 'Bernt Popp',
    description:
      'Dr. med. Bernt Popp, an accomplished board-certified geneticist and senior physician with expertise in human genetics, rare diseases, and bioinformatics.',
...
export default defineConfig({
  ...
  transformPageData(pageData) {
    ...
    if (pageConfig) {
      pageData.title =
        pageConfig.title === 'Home' ? site.title : `${pageConfig.title} | ${site.title}`
  ...
  themeConfig: {
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/berntpopp' }],
  },
